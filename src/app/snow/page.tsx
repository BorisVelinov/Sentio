...
const snowSpecs = [
  ...
  { label: "Lens", value: "Anti-Fog Heated" },
];
    ...
    >
      ...
      <section style={{ paddingTop: "6rem", paddingBottom: "3rem", position: "relative", overflow: "hidden", zIndex: 2 }}>
        ...
        <div className="container-main" style={{ position: "relative", zIndex: 10 }}>
          ...
          >
            <p style={{ fontSize: "0.875rem", textTransform: "uppercase", letterSpacing: "0.3em", color: "rgba(56,189,248,0.8)", marginBottom: "1rem" }}>
              Snow Edition
            </p>
            <h1 style={{ fontSize: "clamp(2.5rem, 6vw, 4.5rem)", fontWeight: 700, letterSpacing: "-0.02em" }}>
              Made for the{" "}
              <span style={{ background: "linear-gradient(90deg, #38bdf8, #67e8f9, #bae6fd)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                Mountain
              </span>
            </h1>
            <p style={{ marginTop: "1.5rem", color: "#a3a3a3", fontSize: "1.125rem", maxWidth: "40rem", margin: "1.5rem auto 0", fontWeight: 300 }}>
              Crystal clarity in the coldest conditions, from first chair to last run.
            </p>
          </motion.div>
          ...
          >
            <div style={{ position: "relative", width: "100%", maxWidth: "550px" }}>
              ...
              <Image
                ...
                height={600}
                priority
                style={{ position: "relative", zIndex: 10, width: "100%", height: "auto", objectFit: "contain", filter: "drop-shadow(0 12px 40px rgba(56,189,248,0.3)) drop-shadow(0 0 80px rgba(93,173,226,0.1))" }}
              />
            </div>
          </motion.div>
                ...
                return (
                  ...
                  >
                    <div style={{ display: "flex", justifyContent: "center", marginBottom: "0.75rem" }}>
                      <Icon style={{ color: "#38bdf8" }} size={24} />
                    </div>
          ...
          <div style={{ maxWidth: "700px", margin: "0 auto" }}>
            ...
            <motion.div
              ...
              style={{
                borderRadius: "1.5rem",
                background: "linear-gradient(180deg, rgba(12,74,110,0.3), rgba(0,0,0,0.6))",
            ...
            >
              ...
              <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "0.5rem", marginBottom: "2rem" }}>
                {["OLED HUD", "HD Camera", "Crash SOS", "Anti-Fog"].map((tag) => (
                  <span key={tag} style={{ fontSize: "0.75rem", color: "#38bdf8", backgroundColor: "rgba(56,189,248,0.08)", padding: "0.375rem 0.75rem", borderRadius: "9999px" }}>
                    {tag}
                  </span>
                ))}
              </div>
